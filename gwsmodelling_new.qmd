...
```{r}
pacman::p_load(sp, sf, st, spdep, raster, spatstat, tmap, devtools,vtable,ggplot2,egg, corrplot, patchwork, ggstats, ggstatsplot, GWmodel, tidyverse, gtsummary,vtable, sjPlot, sjmisc, sjlabelled, tableHTML, olsrr, car, blorr,ISLR, klaR, rsample)
```
...
data.frame(
  ...
  "LR 1" = c(cm$accuracy, cm$sensitivity, cm$accuracy),
  "LR 2" = c(cm2$accuracy, cm2$sensitivity, cm2$accuracy),
  "LR 3" = c(cm3$accuracy, cm3$sensitivity, cm3$accuracy)
)
```
