...
#### 7.03  Lithology
Lithology refers to the type of rock that makes up a slope.
...
#### 7.06  Slope Angle
Slope angle refers to the angle of inclination of the slope surface, measured from the horizontal. It is usually expressed in degrees.
...
Slope aspect direction refers to the direction that a slope faces. It is usually expressed as a compass direction, such as north, south, east, or west.
