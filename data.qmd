...
ggplot()+
  ...
  geom_sf(fill='transparent',data=valtellina)+
  scale_fill_gradientn('twi', colours=c("#9beef0", "#59c1ed", "#0096e6", "#006ad5", "#0036b4", "#020295"))+
  coord_sf(expand=FALSE)+
  labs(x='Longitude',y='Latitude',
...
ggplot()+
  ...
  scale_fill_distiller(palette = "Greys") +
  new_scale_fill() +
  geom_raster(aes(x=x,y=y,fill=slope_degree),data=slope_df, alpha = .6)+
  geom_sf(fill='transparent',data=valtellina)+
  scale_fill_gradientn('twi', colours=c("#ffc809", "#ff7d04","#ff163b","#cc01b8", "#0000ff"))+
  coord_sf(expand=FALSE)+
  labs(x='Longitude',y='Latitude',
       title="Slope Map",
       subtitle='Valtellina Valley, Italy',
